<template>
  <div class="mb-16">
    <div class="bg-deep-purple-accent-400">
      <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        ...
        <div class="flex items-center sm:justify-center">
          <button
            type="submit"
            class="inline-flex items-center justify-center h-12 px-6 mr-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-teal-accent-400 hover:bg-teal-accent-700 focus:shadow-outline focus:outline-none"
          >
            Get started
          </button>
          <a
            ...
            class="inline-flex items-center justify-center w-10 h-10 text-white duration-300 transform border border-gray-400 rounded-full hover:text-teal-accent-400 hover:border-teal-accent-400 hover:shadow hover:scale-110"
          >
            <svg
    ...
    <div class="relative px-4 sm:px-0">
      <div class="absolute inset-0 bg-deep-purple-accent-400 h-1/2"></div>
